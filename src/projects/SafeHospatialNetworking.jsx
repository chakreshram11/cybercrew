...
function SafeHospatialNetworking() {
  const features = [
    {
      image: "/projects/safehosp-encryption.jpg",
      title: "Patient Data Encryption",
      description:
        "Securely encrypt sensitive patient data using advanced algorithms, ensuring compliance with healthcare regulations like HIPAA.",
    },
    {
      image: "/projects/safehosp-monitoring.jpg",
      title: "Network Monitoring",
      description:
        "Real-time monitoring of hospital networks to detect and mitigate threats, maintaining uninterrupted and secure operations.",
    },
    {
      image: "/projects/safehosp-iot.jpg",
      title: "IoT Device Security",
      description:
        "Protect medical IoT devices from unauthorized access, safeguarding critical equipment like monitors and infusion pumps.",
    },
    {
      image: "/projects/safehosp-access.jpg",
      title: "Access Control",
      description:
        "Implement robust access controls to restrict network entry, ensuring only authorized personnel access sensitive systems.",
    },
  ];
    ...
    <section className="w-full bg-gray-900 text-white min-h-screen py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-cyan-400 text-center mb-12 tracking-tight animate-fade-in">
          SafeHospatialNetworking
        </h1>

        {/* Overview */}
        <div className="mb-12 text-center">
          <h2 className="text-2xl sm:text-3xl font-semibold text-white mb-4">
            About SafeHospatialNetworking
          </h2>
          <p className="text-gray-300 text-base sm:text-lg leading-relaxed max-w-3xl mx-auto">
            SafeHospatialNetworking is a cybersecurity solution designed to
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {team.map((member) => (
              ...
              >
                <img
                  src={member.image}
                  alt={`${member.name}, SafeHospatialNetworking founder`}
        ...
        <div className="text-center">
          ...
          <a
            href="https://github.com/cybercrew/safehospatial-networking"
            target="_blank"
            rel="noopener noreferrer"
            ...
            aria-label="Visit SafeHospatialNetworking's GitHub repository"
          >
            View on GitHub
          </a>
        </div>
...
export default SafeHospatialNetworking;