...
function DeepNetGaurd() {
  const features = [
    {
      image: "/projects/deepnet-detection.jpg",
    ...
    {
      image: "/projects/deepnet-dashboard.jpg",
    ...
    <section className="w-full bg-gray-900 text-white min-h-screen py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {team.map((member) => (
              ...
              >
                <img
                  src={member.image}
                  alt={`${member.name}, DeepNet Guardian founder`}
        ...
        <div className="text-center">
          ...
          <a
            href="https://github.com/cybercrew/deepnet-guardian"
            target="_blank"
            rel="noopener noreferrer"
            ...
            aria-label="Visit DeepNet Guardian's GitHub repository"
          >
            View on GitHub
          </a>
        </div>
